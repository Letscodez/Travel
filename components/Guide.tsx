  ...
  return (
    <section className="flexCenter flex-col">
      <div className="padding-container max-container w-full pb-24">
        ...
        <div className="flex flex-wrap justify-between gpa-5 lg:gap-10">
      ...
      <div className="flexCenter max-container relative w-full">
        ...
        <div className="absolute flex bg-white py-8 pl-5 gap-3 rounded-3xl pr-7 border shadow-md md:left-[5%] lg:top-20">
